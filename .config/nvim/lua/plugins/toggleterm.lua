return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "gxx", ":ToggleTermSendCurrentLine<CR><CR>", { desc = "Send current line to terminal" })

    vim.keymap.set("x", "gx", ":ToggleTermSendVisualSelection<CR><CR>", { desc = "Send selection to terminal" })
    ...
    vim.keymap.set("n", "<leader>t", ":ToggleTerm direction=vertical<CR>", { desc = "New terminal on right" })
